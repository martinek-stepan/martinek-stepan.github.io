      ...
      <div class="card-header" :id="project.id+'heading'">
        ...
        <div class="row">
          ...
          <p class="col-6 text-right right-padding">
            <MyTechnology v-for="technology in project.technologies" :key="technology" :technology="technology"/>
          </p>
        </div>
      </div>
...
<script>
import MyCardTabPictures from "@/components/MyCardTabPictures";
import MyCardTabVideo from "@/components/MyCardTabVideo";
import MyCardTabText from "@/components/MyCardTabText";
import MyTechnology from "@/components/MyTechnology";
export default {
  components: {MyTechnology, MyCardTabText, MyCardTabPictures, MyCardTabVideo},
  props: {
